	component Computer_System is
		port (
			arm_a9_hps_h2f_gp_gp_in                    : in    std_logic_vector(31 downto 0) := (others => 'X'); -- gp_in
			arm_a9_hps_h2f_gp_gp_out                   : out   std_logic_vector(31 downto 0);                    -- gp_out
			...
			response_pio_2_external_connection_export  : in    std_logic                     := 'X';             -- export
			response_pio_3_external_connection_export  : in    std_logic                     := 'X';             -- export
			response_pio_4_external_connection_export  : in    std_logic                     := 'X';             -- export
			response_pio_5_external_connection_export  : in    std_logic                     := 'X';             -- export
	...
	u0 : component Computer_System
		port map (
			arm_a9_hps_h2f_gp_gp_in                    => CONNECTED_TO_arm_a9_hps_h2f_gp_gp_in,                    --                   arm_a9_hps_h2f_gp.gp_in
			arm_a9_hps_h2f_gp_gp_out                   => CONNECTED_TO_arm_a9_hps_h2f_gp_gp_out,                   --                                    .gp_out
			...
			response_pio_2_external_connection_export  => CONNECTED_TO_response_pio_2_external_connection_export,  --  response_pio_2_external_connection.export
			response_pio_3_external_connection_export  => CONNECTED_TO_response_pio_3_external_connection_export,  --  response_pio_3_external_connection.export
			response_pio_4_external_connection_export  => CONNECTED_TO_response_pio_4_external_connection_export,  --  response_pio_4_external_connection.export
			response_pio_5_external_connection_export  => CONNECTED_TO_response_pio_5_external_connection_export,  --  response_pio_5_external_connection.export
