package av1_helper_functions;
    ...
    function automatic butterfly_t b_0(input logic signed [15:0] t_a, input logic signed [15:0] t_b, input logic [7:0] angle);
        butterfly_t res;
    ...
    function automatic butterfly_t b_1(input logic signed [15:0] t_a, input logic signed [15:0] t_b, input logic [7:0] angle);
    ...
    function automatic butterfly_t h(input logic signed [15:0] t_a, input logic signed [15:0] t_b, input logic c);
    butterfly_t res;
    res.a = c ? t_b : t_a;
    res.b = c ? t_a : t_b;
    return res;
